...
export class Capabilities {
   ...
   */
   async requestCapabilities(accountID, capabilities) {
    const token = await this.moov.generateToken([SCOPES.CAPABILITIES_WRITE], accountID)
   ...
   */
   async get(accountID, capability) {
    const token = await this.moov.generateToken([SCOPES.CAPABILITIES_READ], accountID)
