 ...
 * @property {"noMatch"|"match"|"notChecked"|"unavailable"} cvv - Card Verification Value
 * @property {"noMatch"|"match"|"notChecked"|"unavailable"} addressLine1 - Street address
 * @property {"noMatch"|"match"|"notChecked"|"unavailable"} postalCode - 5 characters
 * @tag Transfers
 */
...
/**
 * @typedef ACHDetails
 * @property {"initiated"|"originated"|"corrected"|"returned"|"completed"} status - 
