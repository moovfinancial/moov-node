 ...
 * @property {string} sourceID - ID of the source Moov object to which this transaction is related. Can be one of [walletID](/api/#tag/Wallets/operation/getWalletForAccount), [cardID](/api/#tag/Cards/operation/getCard), or [bankAccountID](/api/#tag/Bank-accounts/operation/getBank).
